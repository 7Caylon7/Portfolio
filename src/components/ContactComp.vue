  ...
  <div class="parallax" id="contact">
    <div class="container">
      <div class="main d-flex flex-direction-row">
        ...
        <div class="links">
          <div class="up">
            <a
              class="card1"
              href="https://www.instragram.com/ca_ylon/profilecard/?igsh=YnptaGp3MXFhZmdj"
              target="_blank"
            >
              <i class="instagram mdi mdi-instagram"></i>
            </a>
            <a
              class="card2"
              href="https://www.linkedin.com/in/caylon-solon-monte-costa"
              target="_blank"
            >
              <i class="twitter mdi mdi-linkedin"></i>
            </a>
          </div>
          <div class="down">
            <a class="card3" href="https://github.com/7Caylon7" target="_blank"
              ><i class="github mdi mdi-github "></i
            ></a>
            <a class="card4" href="">
              <i class="discord mdi mdi-whatsapp "></i>
            </a>
          </div>
        </div>
      </div>
      <div>
        ...
        >
          <p class="col-md-4 mb-0">@ 2024 Caylon Solon</p>
          <h3 class="nav">
            <i class="mdi mdi-chevron-left"></i>Solon/<i
